...
static SD_Error CmdResp7Error(void);                              //检查R7响应的状态
static SD_Error CmdResp1Error(u8 cmd);                            //检查R1响应的状态
static SD_Error CmdResp3Error(void);                              //检查R3响应的状态
static SD_Error CmdResp2Error(void);                              //检查R2响应的状态
static SD_Error CmdResp6Error(u8 cmd, u16*prca);                  //检查R6响应的状态
