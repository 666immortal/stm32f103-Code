...
* 注    意:
*********************************************************************************************************/
static u32 MallocMemInw(u8 memx, u32 size)  
{  
...
* 注    意:
*********************************************************************************************************/
static u8 FreeMemInw(u8 memx, u32 offset)  
{  
  int i;                                                   //定义变量，作为循环计数器
  int inDex;                                               //定义变量，用来记录偏移所在内存块号码 
  int nMemb;                                               //定义变量，用来记录内存块数量    
  ...
  {          
    inDex = offset / memBlkSize[memx];                     //记录偏移所在内存块号码    
    nMemb = StructMallocDev.memMap[memx][inDex];           //记录内存块数量    
